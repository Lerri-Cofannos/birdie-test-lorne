...
export function getListOfPatients(next: Function): void {
  function reformating(patientList): IEvent[] {
...
export function getEventsOfPatient(id: string, next: Function): void {
  console.log(
